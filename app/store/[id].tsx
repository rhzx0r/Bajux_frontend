...
export default function StoreDetailScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      const [comercioData, ofertasData] = await Promise.all([
        comercioService.getComercioById(comercioId),
        comercioService.getOfertasByComercio(comercioId)
      ]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.productsGrid}>
          {ofertas.length > 0 ? (
            ofertas.map((oferta) => (
              <View key={oferta.id} style={styles.productCard}>
                <Image
                  source={{
                ...
                <View style={styles.productInfo}>
                  ...
                  <TouchableOpacity
                    style={[styles.addButton, (oferta.stock || 0) === 0 && styles.disabledButton]}
                    onPress={() => handleAddToCart(oferta)}
                    disabled={(oferta.stock || 0) === 0}
                  >
